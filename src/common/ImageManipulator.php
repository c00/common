...
//https://gist.githubusercontent.com/philBrown/880506/raw/9ff4da629801b5b40f86c42a1b709790b23eb6e5/ImageManipulator.php
...
class ImageManipulator
{
    ...
    public function cropToSquare(){
        if ($this->width > $this->height){
            $squareDimension = $this->height;

            $x1 = round(($this->width / 2)) - round(($squareDimension / 2));
            $y1 = 0;

        } else {
            $squareDimension = $this->width;
            $x1 = 0;
            $y1 = round(($this->height / 2)) - round(($squareDimension / 2));
        }

        $temp = imagecreatetruecolor($squareDimension, $squareDimension);
        imagecopy($temp, $this->image, 0, 0, $x1, $y1, $squareDimension, $squareDimension);
